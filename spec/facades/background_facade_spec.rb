...
describe BackgroundFacade, :vcr do
  it 'returns image for location' do
    ...
    expect(response.url).to eq("https://images.unsplash.com/photo-1569820740409-e69bfc1ed752?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwyNjMxNzh8MHwxfHNlYXJjaHwxfHxob25vbHVsdSUyQ2hpfGVufDB8fHx8MTYzMjc3NDk3MQ&ixlib=rb-1.2.1&q=80&w=1080")
